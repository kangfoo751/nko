                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="title-5 m-b-35">our product!</h3>
                                    <div class="table-data__tool-right">
                                            <a href="order/add.php" style="text-decoration: none; color: white;">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>order now!</a></button>
                                    </div>
                                </div>
                                </form>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>    
                                            ...
                                            <?php
                                                ...
                                                $no = 1;
                                                $sql = "SELECT * from stock ORDER BY category ASC";
