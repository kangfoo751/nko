                                ...
                                <h3 class="title-5 m-b-35">category</h3>
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <a href="category/add.php" style="text-decoration: none; color: white;"><i class="zmdi zmdi-plus"></i>add item</a></button>
                                    </div>
                                </div>
                                </form>
                                                ...
                                                if(mysqli_num_rows($jawab)>0){
                                                    while($data = mysqli_fetch_assoc($jawab)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>".$data['name']."</td>
                                                             <td>
                                                                <a href='category/edit.php?id=".$data['id_category']."'
                                                                    class='btn btn-primary btn-sm'><i class='zmdi zmdi-edit'></i>
                                                                </a>
                                                                <a href='category/delete.php?id=".$data['id_category']."'
