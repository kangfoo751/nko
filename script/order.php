                                                ...
                                                $jawab = mysqli_query($konek, $sql);
                                                    ...
                                                    while($data = mysqli_fetch_assoc($jawab)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>".harga($data['price'])."</td>
                                                            <td>".date('d F Y', strtotime($data['deadline']))."</td>
                                                             <td>
                                                                <a href='order/edit.php?id=".$data['id_sale']."'
                                                                    class='btn btn-primary btn-sm' alt='Edit'><i class='zmdi zmdi-edit'></i>
                                                                </a>
                                                                <a href='order/delete.php?id=".$data['id_sale']."'
                                                                    class='btn btn-danger btn-sm' alt='Delete'><i class='zmdi zmdi-delete'></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ";      
