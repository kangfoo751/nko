            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        $sql2   = "SELECT * FROM category WHERE id_category=$value";
                                    ...
                                    <div class="card-body card-block">
                                        <form action="edit_p.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="category" id="select" class="form-control">
                                                        ...
                                                        <?php
                                                            ...
                                                            $jawab = mysqli_query($konek, $sql3);

                                                            if(mysqli_num_rows($jawab)>0){
                                                                while($data4 = mysqli_fetch_assoc($jawab)){
                                                                    echo "<option value=".$data4['id_category'].">".$data4['name']."</option>";      
                                                                }
                                                            }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="product" placeholder="<?= $data['product']?>"class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="price" placeholder="<?= $data['price']?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="radio">
                                                            <label for="radio1" class="form-check-label ">
                                                                <input type="radio" id="radio1" name="status" value="1" class="form-check-input" 
                                                                <?php 
                                                                if ($data['status'] == 1) {
                                                                   echo "checked";
                                                                }
                                                        ...
                                                        <div class="radio">
                                                            <label for="radio2" class="form-check-label ">
                                                                ...
                                                                if ($data['status'] == 0) {
                                                                 ...
                                                                 class="form-check-input">Sold Out
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
...
<!--                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="date" placeholder="<?= $data['date']?>" class="form-control">
                                                </div>
                                            </div> -->
